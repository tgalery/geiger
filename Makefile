...
coling-english:
	mkdir -p datasets/coling && wget -O datasets/coling/english_train.tar.gz https://www.dropbox.com/s/r0mnf6b4sktznek/english_train.tar.gz?dl=1 && cd datasets/coling && tar -xzvf english_train.tar.gz && tar -xzvf trac-test-package.tar.gz && cd -
